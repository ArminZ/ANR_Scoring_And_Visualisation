...
namespace AirNavigationRaceLive.Comps.ANRRouteGenerator
{
    public static class ANRData
    {
        ...
        public static Document createANR(List<List<Vector>> listOfListOfVcts, bool hasMarkers, bool showForbiddenArea, bool isStandardOrder, double channelWidth, string styleName, List<string> routeNames, double altitude)
        {
        ...
        public static List<Vector> combineBorderVectorsForPolygon(List<Vector> lstVectors1, List<Vector> lstVectors2)
        {
        ...
        public static void setAltitude(List<Vector> lstVct, double Altitude)
        {
            // input: two vectors for channel borderlines
            // check if they have the same orientation
            // if yes: invert lstvector2, else do nothing
        ...
        public static SharpKml.Dom.Polygon makeSimplePolygon(List<Vector> lstVct, AltitudeMode altMode)
        {
        ...
        public static SharpKml.Dom.Polygon makeSimplePolygonFromLineString(SharpKml.Dom.LineString lineString, AltitudeMode altMode)
        {
            var pg = new SharpKml.Dom.Polygon();
            List<Vector> lstVct = new List<Vector>();
        ...
        public static SharpKml.Dom.Placemark makeSimplePlacemark(SharpKml.Dom.Polygon poly, string name, string styleName)
        {
        ...
        public static SharpKml.Dom.Placemark makeSimplePlacemark(SharpKml.Dom.LineString lineString, string name)
        {
            var pm = new SharpKml.Dom.Placemark();
